...
//      <div
//   className="popup-content bg-white p-6 rounded-lg shadow-lg mx-auto relative overflow-y-auto h-[100vh]"
...
//   return (
//     <div className="data-display-container fixed inset-0 flex items-center justify-center mt-[10%]   z-50">
//       <div className="popup-content bg-white p-6 rounded-lg shadow-lg  sm:w-[400%] mx-auto relative overflow-y-auto h-[100vh]">
//       {/* <div className="popup-content bg-white p-6 rounded-lg shadow-lg w-800 mx-auto relative overflow-y-auto h-[100vh]"> */}
