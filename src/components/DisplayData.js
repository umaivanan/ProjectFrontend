...
const DisplayData = ({ id, onClose }) => {  // onClose prop இங்கே பெறப்படுகிறது
  ...
  return (
    ...
    style={{ width: '600px', maxWidth: '1200px',borderRadius: '1px', position: 'relative' }}>
      ...
      <div className="space-y-8 h-full">
        ...
        <div className="pdf-links-section border border-blue-500 p-4 rounded-lg shadow-md w-full">
          ...
          <StripeCheckout
            ...
            token={makePayment}
          >
            <button className="payment-button bg-teal-500 text-black p-2 rounded mt-4 w-full">
      ...
      <button
        className="close-button bg-teal-800 text-white p-2 rounded-full mt-4 absolute top-4 right-4"
        onClick={handleClose}
      >
        Close
      </button>
