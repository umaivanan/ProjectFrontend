...
//             const response = await axios.post('http://localhost:8713/api/skills/check-form', { email: decryptedEmail });
...
//     try {
//       const response = await axios.post('http://localhost:8713/api/skills', formData, {
//         headers: {
...
//       await axios.patch(`http://localhost:8713/api/skills/${skillId}`, { submittedStatus: true });
